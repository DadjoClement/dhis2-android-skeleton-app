...
public class DataSetReportsAdapter extends PagedListAdapter<DataSetReport, ListItemWithSyncHolder> {
    ...
    public void onBindViewHolder(@NonNull ListItemWithSyncHolder holder, int position) {
        ...
        holder.title.setText(dataSetReport.dataSetDisplayName().toString());
        holder.subtitle1.setText(dataSetReport.organisationUnitDisplayName().toString());
        holder.subtitle2.setText(dataSetReport.periodType().name().toString());
