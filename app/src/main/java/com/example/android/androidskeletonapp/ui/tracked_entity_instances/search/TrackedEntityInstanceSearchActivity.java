...
public class TrackedEntityInstanceSearchActivity extends ListActivity {
    ...
    private void searchTrackedEntityInstances() {
        ...
        //List<OrganisationUnit> organisationUnits = new ArrayList (Sdk.d2().organisationUnitModule().organisationUnits.byRootOrganisationUnit(true).get());
        List<OrganisationUnit> organisationUnits = new ArrayList (Sdk.d2().organisationUnitModule()
                .organisationUnits.byOrganisationUnitScope(OrganisationUnit.Scope.SCOPE_DATA_CAPTURE).get());
        ...
        TrackedEntityAttribute attribute = Sdk.d2().trackedEntityModule().trackedEntityAttributes
                .byName().eq("Malaria patient id").one().get();
        ...
        TrackedEntityInstanceQuery query = TrackedEntityInstanceQuery.builder()
                ...
                .filter(Collections.singleton(QueryItem.create(attribute.id(), )))
